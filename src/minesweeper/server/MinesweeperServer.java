...
//import minesweeper.Board.BoomException;
import java.io.*;
import java.net.*;
import java.util.*;
...
public class MinesweeperServer {
    ...
    private Board board; // Assume Board is defined in the same package or imported
    //private int sizeX,sizeY;
    // TODO: Abstraction function, rep invariant, rep exposure
    private static AtomicInteger currentPlayerCount = new AtomicInteger(0);
     ...
     */
    public void serve(int sizeX,int sizeY) throws IOException {
        while (true) {
            ...
            String helloMessage = "Welcome to Minesweeper. Board: " + sizeX + " columns by " + sizeY
                    + " rows. Players: " + currentPlayerCount.get() + " including you. Type 'help' for help.\n";
    ...
    private String handleRequest(String input) {
        ...
        if (tokens[0].equals("look")) {
            ...
            if (tokens[0].equals("dig")) {
                ...
                if (hitBomb) {
                    if (debug){
                        board.calculateAdjacencyCounts();}
                    return "BOOM!\n";
                } else {
                ...
                // 'flag x y' request
                // TODO Problem 5
                board.flag(Integer.parseInt(tokens[1]), Integer.parseInt(tokens[2]));
                return board.toString() + "\n";
    ...
    public static void runMinesweeperServer(boolean debug, Optional<File> file, int sizeX, int sizeY, int port) throws IOException {
        ...
        server.board=new Board(sizeX, sizeY);
        server.serve(sizeX,sizeY);
    }
    ...
    public class ClientHandler implements Runnable {
        ...
        public void run() {
            ...
            MinesweeperServer.currentPlayerCount.decrementAndGet();
        }
    }
